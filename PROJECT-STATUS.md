...
**Last Updated:** 2026-04-15 (Task 2.5.2 GET `/api/archive/signals` complete)
**Current Phase:** Giai đoạn 3 - Implementation
**Current Sprint:** Sprint 2 — My KOLs + Archive (2.5.x)
**Completed Task:** **2.5.2** — GET `/api/archive/signals` (list archived + filters) ✅ — 2026-04-15
**Next Task:** **2.5.3** (Save to Archive button on Digest) / **3.1.1** (Stripe) — xem `IMPLEMENTATION-ROADMAP.md`
**Status:** Sprint 2 roadmap table (**14** tasks) — **14/14** ✅; backlog **2.5.x** (Archive / Settings): **2/7** task archive+settings nhóm 2.5.x hoàn thành (2.5.1–2.5.2 ✅)
...
- **Archive backlog:** ✅ **2.5.1** `POST/DELETE /api/signals/{id}/archive` (2026-04-15); ✅ **2.5.2** `GET /api/archive/signals` (2026-04-15) — **Next:** **2.5.3** Digest save button / **3.1.1** Stripe — `IMPLEMENTATION-ROADMAP.md`
...
**Current phase:** Sprint 2 — My KOLs **hoàn tất** (bundle 14 task); backlog **2.5.x** (Archive) — **2.5.1** ✅ **2.5.2** ✅; next **2.5.3** / Sprint 3
